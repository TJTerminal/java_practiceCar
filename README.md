# Practice Car
Object-oriented command line car
...
1. Every class representing a car part should inherit from a superclass called "CarPart." The CarPart class will have at least the following states and behaviors:
    i. condition - an integer that represents the remaining durability of the part (starts at 100, goes down to 0 when the part is broken)
    ii. status() - a method that prints the condition of the part to the console.
